...
const websocket_uri = 'ws://localhost:8000';
...
function initWebSocket() {
    ...
    websocket = new WebSocket(websocketAddress + "/?lang=" + language);
    websocket.onopen = () => {
...
function updateTranscription(transcript_data) {
    ...
    if (transcript_data['Transcript']) {
            ...
            span.textContent = transcript_data['Transcript'];
        ...
        transcriptionDiv.textContent += transcript_data['Transcript'] + '\n';
    }
